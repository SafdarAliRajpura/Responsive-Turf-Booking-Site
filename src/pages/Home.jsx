...
import {
    ...
    MapPin, Star, ArrowRight, Menu, Bell,
    ...
    <nav className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/70 border-b border-white/10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
                <button className="text-white hover:text-neon-green transition-colors">Home</button>
                        ...
                        >
                            ...
                            <div className="absolute bottom-8 left-8 right-8 bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-3xl">
                                <div className="flex items-center justify-between mb-2">
                                    <h4 className="text-white font-bold text-lg">Neon Arena, Downtown</h4>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="px-4 py-2 bg-white text-black text-sm font-bold rounded-xl hover:bg-neon-green transition-colors">Book Now</button>
                                </div>
                            </div>
                        </motion.div>
                ...
                <div className="relative rounded-[3rem] overflow-hidden bg-slate-900 border border-white/10 px-6 py-20 text-center">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-4">
                            <button className="px-8 py-4 bg-neon-green text-black font-black uppercase tracking-wider rounded-2xl hover:bg-white hover:scale-105 transition-all shadow-[0_0_20px_rgba(57,255,20,0.3)]">
                                Start Booking
                            </button>
