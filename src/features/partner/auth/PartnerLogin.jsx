                ...
                >
                    <div className="relative backdrop-blur-2xl bg-slate-900/50 border border-white/10 rounded-[2rem] p-8 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden">
                        ...
                        <div className="text-center mb-8">
                            ...
                            >
                                <Briefcase className="w-8 h-8 text-black" strokeWidth={2.5} />
                            </motion.div>
                            <motion.h2
                            ...
                            >
                                PARTNER <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-green">LOGIN</span>
                            </motion.h2>
                            <motion.p
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                        ...
                        >
                            <div className="relative mb-6">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-4 bg-slate-900/50 text-slate-500">Need an account?</span>
                                </div>
                            </div>
                            <button onClick={() => navigate('/partner/register')} className="text-neon-green hover:underline font-bold">Apply for Partnership</button>
                        </motion.div>
                        ...
                        >
                            <button onClick={() => navigate('/login')} className="text-xs text-slate-500 hover:text-white transition-colors">Back to User Login</button>
                        </motion.div>
